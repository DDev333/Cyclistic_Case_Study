...
View(filter(clean_final_data, clean_final_data$ride_length>1440 | clean_final_data < 5))
#----------------------------------------------------------------------------------#
```
...
View(aggregate(clean_final_data$ride_length ~ clean_final_data$costumer_type + 
                 clean_final_data$month, FUN = mean))
#----------------------------------------------------------------------------------#
```
...
![](Visualizations/total_riders_vs_week_day.png){width="651"}
...
![](Visualizations/total_rider_vs_time_of_day.png)
...
![](Visualizations/avg_rider_length_vs_week_day.png){width="672"}
...
![](Visualizations/avg_rider_length_vs_month.png){width="719"}
...
![](Visualizations/customer_type_bikewise.png){width="537"}
...
![](Visualizations/total_bike_type.png){width="837"}
